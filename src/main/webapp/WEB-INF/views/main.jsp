      ...
      success:function(data){      
         var arr =  data.response.body.items.item;
          ...
          for(var i in arr){
            ...
            }else if(arr[i].wf=='구름많고 한때 비/눈'){
               chtml+="<th><img src='./images/sleet.png'></th>";
            }else if(arr[i].wf=='흐리고 한때 눈 곳'){
               chtml+="<th><img src='./images/snow.png'></th>";
            }else if(arr[i].wf=='구름많고 한때 눈 곳'){
               chtml+="<th><img src='./images/snow.png'></th>";
            }else if(arr[i].wf=='흐리고 가끔 비'){
               chtml+="<th><img src='./images/cloudrain.png'></th>";
            }else if(arr[i].wf=='흐리고 한때 비'){
               chtml+="<th><img src='./images/rain.png'></th>";
            }else if(arr[i].wf=='구름많고 가끔 비'){
               chtml+="<th><img src='./images/cloudrain.png'></th>";
            }else if(arr[i].wf=='구름많고 한때 비'){
               chtml+="<th><img src='./images/cloudrain.png'></th>";
			...
			<div class="mid_section">
				...
				<div class="mini_board">
					<ul class="nav nav-tabs">
						...
						<li class="nav-item">
							<a class="nav-link" data-toggle="tab" href="#menu4">농장주게시판</a>
						</li>
						</c:if>
					</ul>
					<!-- 탭 목록 -->
					<div class="tab-content">
						...
						<div id="home" class="container tab-pane active"><br>
							<table style="width: 800px;">
								...
								<tr class="trtd">
									<td>${bDto.bn_no}</td>
									<td><a id="noneblue" href="board/board_public_view?bn_no=${bDto.bn_no}">${bDto.bn_title }</a></td>
									<td>${bDto.bn_date }</td>
									<td>${bDto.bn_hit }</td>
								</tr>
								</c:forEach>
						...
						<div id="menu1" class="container tab-pane fade"><br>
							<table style="width: 800px;">
								...
								<c:forEach items="${biDto}" var="biDto">
								<tr class="trtd">
									<td>${biDto.bn_no}</td>
									<td><a id="noneblue" href="board/board_info_view?bn_no=${biDto.bn_no}">${biDto.bn_title }</a></td>
									<td>${biDto.bn_date }</td>
									<td>${biDto.bn_hit }</td>
								</tr>
								</c:forEach>
						...
						<div id="menu2" class="container tab-pane fade"><br>
							<table style="width: 800px;">
								...
								<c:forEach items="${trDto}" var="trDto">
								<tr class="trtd">
									<td>${trDto.bt_no}</td>
									<td><a id="noneblue" href="/board/board_comm?bc_no=${trDto.bc_no}&bt_no=${trDto.bt_no}">${trDto.bt_title }</a></td>
									<td>${trDto.bt_date }</td>
									<td>${trDto.bt_hit }</td>
								</tr>
								</c:forEach>
						...
						<div id="menu3" class="container tab-pane fade"><br>
							<table style="width: 800px;">
								...
								<c:forEach items="${freeDto}" var="freeDto">
								<tr class="trtd">
									<td>${freeDto.bt_no}</td>
									<td><a id="noneblue" href="/board/board_comm?bc_no=${freeDto.bc_no}&bt_no=${freeDto.bt_no}">${freeDto.bt_title }</a></td>
									<td>${freeDto.bt_date }</td>
									<td>${freeDto.bt_hit }</td>
								</tr>
								</c:forEach>
							</table>
						</div>
						...
						<div id="menu4" class="container tab-pane fade"><br>
							<table style="width: 800px;">
								...
								<tr class="trtd">
									<td>${userDto.bt_no}</td>
									<td><a id="noneblue" href="/board/board_comm?bc_no=${userDto.bc_no}&bt_no=${userDto.bt_no}">${userDto.bt_title }</a></td>
									<td>${userDto.bt_date }</td>
									<td>${userDto.bt_hit }</td>
								</tr>
								</c:forEach>
							</table>
						</div>
						...
						<div id="menu4" class="container tab-pane fade"><br>
							<table style="width: 800px;">
								...
								<c:forEach items="${farmerDto}" var="farmerDto">
								<tr class="trtd">
									<td>${farmerDto.bt_no}</td>
									<td><a id="noneblue" href="/board/board_comm?bc_no=${farmerDto.bc_no}&bt_no=${farmerDto.bt_no}">${farmerDto.bt_title }</a></td>
									<td>${farmerDto.bt_date }</td>
									<td>${farmerDto.bt_hit }</td>
								</tr>
								</c:forEach>
							</table>
						</div>
					</div>
					<div style="width:800px; background-color: #538F6A;">
						<h3 style="color:white; font-size:23px; padding:10px 20px">월별 파종 추천 작물</h3>
					</div>
					<div style="height:179px; width:800px; overflow:hidden; margin-top:20px;">
					<a href="http://www.woven.co.kr/Plant/Plan">
						<div style="width:33.3333%; float:left; text-align: center;">
							<h2>${month.onemonth }월</h2>
							<img src="../images/${mDto[3].cr_name }.png">
						</div>
						<div style="width:33.3333%; float:left; text-align: center;">
							<h2>${month.twomonth }월</h2>
							<img src="../images/${mDto[2].cr_name }.png">
						</div>
						<div style="width:33.3333%; float:left; text-align: center;">
							<h2>${month.thrmonth }월</h2>
							<img src="../images/${mDto[1].cr_name }.png">
							<img src="../images/${mDto[0].cr_name }.png">
						</div>
					</a>
					</div>
				</div>
								...
								<div class="item" id="">
									<div class="block-4 text-center" id="inneritem">
										<figure class="block-4-image">
											<a href="product/product_view?p_no=${pDto.p_no}&p_name=${pDto.p_name}&p_way=${pDto.p_way}&p_num=${pDto.p_num}&p_term=${pDto.p_term}
										...
										<div class="block-4-text p-4"><!-- 03 -->
											<h3><a href="product/product_view?p_no=${pDto.p_no}&p_name=${pDto.p_name}&p_way=${pDto.p_way}&p_num=${pDto.p_num}&p_term=${pDto.p_term}
											&pc_no=${pDto.pc_no}&p_price=${pDto.p_price}&p_info=${pDto.p_info}&p_pic=${pDto.p_pic}&p_picd=${pDto.p_picd}
											&p_picd2=${pDto.p_picd2}&p_picd3=${pDto.p_picd3}&p_picd4=${pDto.p_picd4}&p_picd5=${pDto.p_picd5}">${pDto.p_name}</a></h3>
			...
			<div class="h_slider_container services_slider_container">
				<div class="service_slider_outer">
					...
					<div class="owl-carousel owl-theme services_slider">
						...
						<!-- 첫번째-->
						<c:if test="${session_uno!=null }">
						<c:forEach items="${map.fList}" var="fDto">
						<div class="owl-item services_item">
							<a href="farm/farm_view?fr_no=${fDto.fr_no}&u_no=${session_uno}" id="notline">
						...
						<c:forEach items="${map.fList}" var="fDto">
						<div class="owl-item services_item">
							<a href="farm/farm_view?fr_no=${fDto.fr_no}&u_no=0" id="notline">
								<div class="services_item_inner">
									<div class="service_item_content">
										<div class="service_item_title">
											<img src="../upload/${fDto.fr_thumb }">
