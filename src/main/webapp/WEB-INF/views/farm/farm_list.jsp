                ...
                <ul class="shop-list half" id="anotherlist">
                    ...
                    <li>
                        <div class="shop-list-box gold">
                            <a href="./farm_view?fr_no=${farmDto.fr_no}&u_no=${session_uno }&page=${map.pDto.page}&searchword=${map.pDto.searchword}&category=${map.pDto.category}&region=${map.pDto.region}">
                            ...
                            <div class="shop-main-area">
                                <div class="shop-main">
                                    <div class="shop-main-top">
                                        <p class="tit">
                                            <a href="./farm_view?fr_no=${farmDto.fr_no}&u_no=${session_uno }&page=${map.pDto.page}&searchword=${map.pDto.searchword}&category=${map.pDto.category}&region=${map.pDto.region}">${farmDto.fr_name}</a>
                                        </p>
                                    </div>
                    ...
                    <li>
                        <div class="shop-list-box gold">
                            <a href="./farm_view?fr_no=${farmDto.fr_no}&u_no=0&page=${map.pDto.page}&searchword=${map.pDto.searchword}&category=${map.pDto.category}&region=${map.pDto.region}">
                                <div class="shop-top type">
                                    <div class="shop-img-list slick-initialized slick-slider">
                                        <div aria-live="polite" class="slick-list draggable">
                                            <div class="slick-track" role="listbox" style="opacity: 1; width: 2250px;">
